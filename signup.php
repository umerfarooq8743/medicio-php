...
<html>
<head>
<title>MEDICIO | SignUp Form</title>
          ...
          <?php 
             ...
             if(isset($_POST['btnsub'])){
               ...
               if($Password==$Repassword){
                ...
                $insert=mysqli_query($con,"INSERT INTO tblmedinfo  VALUES ('null','$Name','$Email','$Password')");
                 
                echo '<meta http-equiv="refresh" content="0; url=login.php"/>';

               }
               else{
                 echo "<center><h5 style='color:white;'>Password Didn't Match - Try Again </h5></center>";
               };
